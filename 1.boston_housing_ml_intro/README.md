...
This is a part of the Udacity ML Nanodegree. (I actually used the same exact dataset for my Statistical Machine Learning coursework at Rice U and was trying to find the Octave code I had implemented.. but seemed to have misplaced the zip.)
